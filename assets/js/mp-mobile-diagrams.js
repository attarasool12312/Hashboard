...
function modelOneClick(event) {
  ...
  if (doubleBox == false) {
    ...
    zeeAmo.style.left = `${width * 200}px`;

    var newMainDiv = document.createElement("div");
    newMainDiv.style.width = "200px";
    newMainDiv.style.height = "170px";
    newMainDiv.style.display = "flex";
    newMainDiv.style.justifyContent ='space-around'
    newMainDiv.style.flexWrap = "wrap";

    var createdDivChildOne = document.createElement("div");
    createdDivChildOne.style.width = "106px";
    var newImage = document.createElement("img");
    newImage.src = `./assets/images/diagram/${event.target.id}.png`;
    ...
    // newMainDiv.appendChild(createdDivChildThree);
    zeeAmo.appendChild(newMainDiv);
    // zee[0].parentNode.appendChild(zeeAmo)
    console.log("zee", zee[0]);

    zee[0].appendChild(zeeAmo);
    alreadyDivsRigth.push({
      boxName: currntpusherDiv,
      imageone: `./assets/images/diagram/${event.target.id}.png`,
    });
    ...
    // alreadyDivsBottom.push({
    //   imageone: `./images/diagram/${event.target.id}.png`,
    // });
    ...
    if (noofImgsdoubleBox == 0) {
      ...
      zeeAmofree.style.height = "140px";
      zeeAmofree.style.top = "0px";
      zeeAmofree.style.width = "200px";
      zeeAmofree.style.display = 'flex'
      zeeAmofree.style.justifyContent = 'space-around'
      ...
      zeeAmofree.style.left = `${width * 200}px`;
      // zeeAmofree.style.left
      // zeeAmofree.style.left = `${alreadyDivsRigth.length * 140}px`;
      var happenedDiv =
        document.getElementsByClassName(doubleBoxClass)[0];
      happenedDiv.style.height = "140px";

      var newMainDivOne = document.createElement("div");
      newMainDivOne.style.width = "140px";
      newMainDivOne.style.height = "140px";
      ...
      // newMainDivOne.style.marginTop = '-60px'
      ...
      // newMainDivOne.appendChild(createdDivChildThree);
      noofImgsdoubleBox += 1;
    ...
    twoChildTwoAnotherChild[0].appendChild(lop);
      ...
      happenedDiv.style.height = "280px";
      // happenedDiv.style.marginTop = '-50px'
      // mainforphotos.style.paddingTop = '50px'
      ...
      createdDivChildOne.style.justifyContent = "center";
      createdDivChildOne.style.alignItems = "center";
      createdDivChildOne.style.width = 'auto'
      var createdDivChildTwo = document.createElement("div");
      createdDivChildTwo.className = `ccp${parseInt(
        Math.random() * 1000
      )}plloo`;
      ...
      // newMainDivTwo.style.marginTop = "40px";
      // newMainDivTwo.appendChild(createdDivChildTwo);
      // newMainDivTwo.appendChild(createdDivChildThree);
      var lop = document.createElement("div");
    lop.innerHTML = `  <div class="desMain">
        <div class="counting">${count}</div>
        <div class="written">
...
function rightArrowmodelClick(event) {
  ...
  // console.log("ppel", ppel[0].childNodes);
  ppel[0].innerHTML = "";
  secondtemporaryClass = "";
  ...
  if (
    ...
    expandOneImage.addEventListener("mouseover", (event) => {
      // console.log("OVER",event.target.parentNode.parentNode.parentNode.parentNode.parentNode.style.top),
      // toop = `${event.target.parentNode.parentNode.parentNode.parentNode.style.top}`;
      console.log(
        "OVER",
    ...
    ].rightArroe = `./images/rightArrows/${event.target.id}.png`;
    // alreadyDivsBottom.pop();
    // console.log("alreadyDivsBottom", alreadyDivsBottom);
    console.log("alreadyDivsRigth", alreadyDivsRigth);
