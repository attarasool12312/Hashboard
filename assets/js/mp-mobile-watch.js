...
function modelOneClick(event) {
  ...
  if (doubleBox == false) {
    ...
    newImage.src = `./assets/images/watch/${event.target.id}.png`;
    ...
    alreadyDivsRigth.push({
      ...
      imageone: `./assets/images/watch/${event.target.id}.png`,
    });
    ...
    twoChildTwoAnotherChild[0].appendChild(lop);
      ...
      newMainDivTwo.style.height = "90px";
