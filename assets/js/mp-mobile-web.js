...
count+=1;
  ...
  if (doubleBox == false) {
    ...
    zeeAmo.style.left = `${width * 300}px`;

    var newMainDiv = document.createElement("div");
    newMainDiv.style.width = "300px";
    ...
    createdDivChildOne.style.width = "196px";
    var newImage = document.createElement("img");
    newImage.src = `./assets/images/web-dasktop/${event.target.id}.png`;
    ...
    createdDivChildTwo.style.width = "94px";
    ...
    createdDivChildThree.style.width = "196px";
    ...
    alreadyDivsRigth.push({
      ...
      imageone: `./assets/images/web-dasktop/${event.target.id}.png`,
    });
    ...
    if (noofImgsdoubleBox == 0) {
      ...
      zeeAmofree.style.left = `${width * 300}px`;
      var happenedDiv =
      ...
      newMainDivOne.style.width = "300px";
      ...
      createdDivChildTwo.appendChild(rightarrowImage);
      createdDivChildTwo.style.width = "96px";
      createdDivChildTwo.style.display = "flex";
      createdDivChildTwo.style.justifyContent = "center";
      createdDivChildTwo.style.alignItems = "center";
      var createdDivChildThree = document.createElement("div");
    ...
    twoChildTwoAnotherChild[0].appendChild(lop);
      ...
      newMainDivTwo.style.width = "300px";
