...
(function () {
  ...
  // Line Chart
  // --------------------------------------------------------------------
  const lineChartEl3 = document.querySelector('#lineChart3'),
    lineChartConfig3 = {
      chart: {
        height: 512,
        type: 'line',
  ...
  if (typeof lineChartEl3 !== undefined && lineChartEl3 !== null) {
    const lineChart3 = new ApexCharts(lineChartEl3, lineChartConfig3);
    lineChart3.render();
  }
